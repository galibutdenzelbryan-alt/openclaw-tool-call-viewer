...
- **Linux:** Find the terminal in your applications or press `Ctrl + Alt + T`.

### 6. **Navigate to the Application Folder**
Using the terminal or command prompt, you must navigate to the folder where you extracted the openclaw-tool-call-viewer files. Use the `cd` command followed by the path to your folder. For example:
...
Before running the application, you need to install the necessary dependencies. In the terminal, type the following command:

```
npm install
```

This will download and set up everything the application needs to run.

### 8. **Run the Application**
Now that you have everything set up, you can launch the openclaw-tool-call-viewer. In your terminal, type:

```
npm start
```

Your web browser should open automatically, displaying the openclaw-tool-call-viewer interface.
...
## 🛠️ License
This project is licensed under the MIT License. Feel free to use and modify the application as you wish.

## 📅 Changelog
Check the release notes for updates, improvements, and fixes in each version.

## 📞 Contact
For any questions or feedback, please reach out via the Issues section on our GitHub page.

Thank you for choosing openclaw-tool-call-viewer! Enjoy browsing your session tool call history.